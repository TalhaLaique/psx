...
#Initializing an array of headers for the data
...
#For skimming across the extracted data I will be using BeautifulSoup lib and an html.parser
soup = BeautifulSoup(plain_text, "html.parser")

#Setting the name of the excel document to current data and time - Script execution data and time
